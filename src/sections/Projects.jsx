...
const Projects = () => {
  ...
  return (
    <section id="projects" className="section-padding bg-navy-light/30">
        ...
        >
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                >
                  ...
                  >
                    {/* Image Placeholder */}
                    <div className="relative aspect-video bg-accent/10 border border-accent/30 flex items-center justify-center">
          ...
          >
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center space-x-2 px-6 py-3 border-2 border-accent text-accent rounded-lg hover:bg-accent/10 transition-all duration-200 font-mono"
            >
